...
function handleResponse() {                                             // Verarbeitung der Antwort des Servers
    ...
    if( resObj.status == 200 && resObj.onreadystate === 4 ){      // 4 Die angefragten DAten sind komplett am xhr Object angekommen 200 Datei ist am Server vorhanden
        let antwort = document.getElementById("antwort");
        console.trace(antwort);
